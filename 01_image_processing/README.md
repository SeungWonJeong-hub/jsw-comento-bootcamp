...
```
01_image_processing/          # 저장소 루트가 아니라 이 과제 폴더 기준입니다
...
# [2] 전처리 파이프라인 — 위에서 나온 thresholds.json 을 읽어 씁니다
...
전에는 "정답 마스크가 없으므로 정확한지 판정할 수 없습니다"로 끝냈습니다. 전수 채점을
