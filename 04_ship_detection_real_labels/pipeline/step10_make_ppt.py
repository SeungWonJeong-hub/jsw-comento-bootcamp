...
def slide3(prs):
    sl = base(prs, "03 / 결과", "10척 중 9척 넘게 찾습니다 — 항구 5곳 모두",
              "학습에 안 쓴 사진 453장(배 1,228척)으로 채점. 세 번 학습한 평균이고, 반복마다 차이는 ±0.004 뿐입니다.", 3)
