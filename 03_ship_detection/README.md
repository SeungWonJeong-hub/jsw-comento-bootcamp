...
한국 확장을 4차 과제로 계획했다가 접었습니다 — 이유는 10절에 있습니다.
...
## 10. 4차로 넘기려던 것 — 한국 확장은 접었습니다

3차는 핀란드 해역에서 끝냅니다. 4차는 이 모델을 한국으로 가져가 웹앱으로
만들 계획이었고, 아래가 그때까지 준비해 둔 것입니다.

> **결과부터 적습니다.** 4차는 한국이 아니라 **미국 군항 5곳**(HRSC2016,
> 약 0.45 m)으로 갔습니다. 국내 항만에서 쓸 수 있는 참조 자료가 GFW·AIS
> 대조뿐이라 **사람이 그린 정답이 없었고, 정답이 없으면 정밀도를 잴 수
> 없기** 때문입니다. 아래 준비물은 그대로 남아 있어, 실측 라벨을 확보하면
> 다시 꺼내 쓸 수 있습니다.
> → [`04_ship_detection_real_labels/`](../04_ship_detection_real_labels/)

### 이미 준비된 것

| | 내용 |
|---|---|
| 항만 목록 | 22곳 등록 완료 (`korea_ports.py`) — 이 중 한 곳부터 열 계획이었음 |
...
항만 22곳을 다 여는 대신 **한 곳을 제대로 만드는 것부터** 시작할 계획이었습니다.
