...
카메라 좌표계만 보면 SPE3R 에는 스테레오 베이스라인이 없다. 병진이 항상
(0, 0, Z) 이기 때문이다. 그러나 타겟이 회전하므로 두 뷰의 상대 자세
(R_ij, t_ij) 를 계산하면 유효 베이스라인이 드러나고, 삼각측량이 성립한다.
본 실험의 주 방법이 그것이다. src/stereo.py 를 참고할 것.
"""
